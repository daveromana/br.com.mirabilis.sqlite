...
public class SQLDAO {
	 ...
	 */
	public SQLDAO(Context context,String dbName, SQLEntity entity) throws SQLConnectionException {
	 ...
	 * @throws SQLConnectionException 
	 */
	public void open() throws SQLException, SQLConnectionException{
		try{
			this.database = sqlConnection.getWritableDatabase();
		}catch (Exception e) {
			throw new SQLConnectionException("Aconteceu um erro na abertura do sqllite");
		}
	}
