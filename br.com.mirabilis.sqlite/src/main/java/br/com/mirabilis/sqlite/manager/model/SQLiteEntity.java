...
/**
 * Class of {@link br.com.mirabilis.sqlite.manager.model.SQLiteEntity}
 *
...
public final class SQLiteEntity {
     ...
     * Return all fields;
     *
     * @return {@link java.util.List< SQLiteField >}
     */
    ...
    /**
     * Return query that delete entity
     *
     * @return
     */
     ...
     *
     * @author Rodrigo Sim�es Rosa Foreign key ON DELETE and ON UPDATE clauses
